...
public class ConfigParser {
    ...
    private LinkedList createServerList(File data) throws Exception {
        ...
        digester.addCallParam("config/cluster-server/server", 0, "scheme");
        digester.addCallParam("config/cluster-server/server", 1, "domainName");
        digester.addCallParam("config/cluster-server/server", 2, "path");
        // Create rule
