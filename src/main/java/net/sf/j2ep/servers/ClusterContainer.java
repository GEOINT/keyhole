...
public abstract class ClusterContainer extends ServerContainerBase
     ...
     *
     * @param scheme the URL scheme needed to communicate
     ...
     * server from the requests session.
     *
    ...
    /**
     * Checks the request for any session. If there is a session created we make
     * sure that the server returned is the one the issued the session. If no
     * session is included in the request we will choose the next server in a
     * round-robin fashion.
     *
     * @param request
     * @return
    ...
    /**
     * Sets the server to offline status. Will only handle servers that are
     * ClusteredServers
     *
     * @see
    ...
    /**
     * Sets the server to online status. Will only handle servers that are
     * ClusteredServers
     *
     * @see
     ...
     *
     * @param scheme the URL scheme to identify how it communicates
    ...
    /**
     * A server in the cluster. Will have access to the encapsulating Cluster so
     * that we can use its methods to get the rule and such.
     *
     * @author Anders Nyman
     */
    protected class ClusteredServer implements Server {
        ...
        /**
         * The URL scheme identifying the protocol to communicate with the
         * server.
         */
         ...
         * @param serverId
         */
        public ClusteredServer(String scheme, String domainName,
                String path, String serverId) {
            this.scheme = scheme;
        ...
        /**
         * Notifies the server status checker that a server might have gone
         * offline.
         *
         * @see
