...
/**
 * A handler for GET, HEAD, DELETE. Since these methods basically only will need
 * the headers set they can be handled by the same handler.
 *
 * @author Anders Nyman
 */
public class BasicRequestHandler extends RequestHandlerBase {
    ...
    public HttpMethod process(HttpServletRequest request, String url) 
        ...
        if (request.getMethod().equalsIgnoreCase("GET")) {
            ...
            System.out.println("HttpServletRequest method not identifiable: " 
                    + request.getMethod());
            return null;
        }
